...
<div class="container margin-t-60">
    <a href="view-all.php?city=<?php echo $city; ?>" class="grey">
        <h2 class="h4 font-24 grey text-center bold center">New On FineDine In <?php echo $city; ?> <span
                class="grey-light padding-r-10 padding-l-10 font-18">|</span><span class="normal font-14">See All</span>
        </h2>
    </a>
    ...
    <div class="margin-t-30">
        <div class="grid gutter-grid">
            ...
            $query = "SELECT * FROM hotels WHERE city = '$city' ORDER BY hid DESC LIMIT 3 ";
            ...
            while ($row = mysqli_fetch_assoc($resultSet)) {
           	...
           	<div class="w-4-12 w-lg-4-12">
					<div class="bg-white shadow">
						<div class="img1-8 img-hover"><a href="<?php echo "hotels/hotel.php?city=$city&hotel_id=$hotel_id";?>"><img src="images/hotels/<?php echo $city."/".$hotel_id;?>/image1.png"  alt="Emperor&#039;s Court"></a></div>
						<div class="padding-20">
							...
							<div class="margin-t-20 grid v-center">
								<div class="w-3-12 text-right"><a href="<?php echo "hotels/hotel.php?city=$city&hotel_id=$hotel_id";?>" class="button-hollow btn-explore small" role="button">Explore</a></div>
                        ...
                        <li>
                            <div class="grid">
                                <div class="w-2-12 v-center"><span class="ico ico-lg-md"><svg
                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 63.91 64">
                                            <g>
                                                <path
                                                ...
                                                <polygon
                                                    points="18.01 44.92 45.23 17.73 45.59 18.09 18.37 45.28 18.01 44.92"
                ...
                <div class="bg-white padding-20 h-100 padding-t-b-30 shadow">
                    <ul class="list">
                        <li>
                            <div class="grid">
                                <div class="w-2-12 v-center"><span class="ico ico-lg-md"><svg
                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 61.18 62.92">
                                            <g>
                                                ...
                                                <line x1="56.51" y1="11.15" x2="51.46" y2="16.21"
                                                      style="fill:none;stroke:#616161;stroke-linecap:round;stroke-linejoin:round;stroke-width:2.859452215418886px"/>
                                                <path d="M35,9.79A26.12,26.12,0,1,1,18.56,56.21"
                                                      transform="translate(-1.41 -0.54)"
                                                      style="fill:none;stroke:#616161;stroke-linecap:round;stroke-linejoin:round;stroke-width:2.859452215418886px"/>
                                            </g>
                                        </svg></span></div>
                                <div class="w-10-12 padding-l-20">
                ...
                <div class="bg-white h-100 padding-20 padding-t-b-30 shadow">
                    <ul class="list">
                        <li>
                            <div class="grid">
                                <div class="w-2-12 v-center"><span class="ico ico-lg-md"><svg
                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 63.05 57.79">
                                            <g>
                                                <path
