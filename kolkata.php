			...
			<?php
				...
				<div class="w-4-12 w-lg-4-12">
					<div class="bg-white shadow">
						<div class="img1-8 img-hover"><a href="hotels/<?php echo $city."/".$hotel_id.".php";?>"><img src="images/hotels/<?php echo $city."/".$hotel_id;?>/image1.png"  alt="Emperor&#039;s Court"></a></div>
						<div class="padding-20">
							<a href="hotels/<?php echo $city."/".$hotel_id.".php";?>">
							...
							<div class="margin-t-20 grid v-center">
								<div class="w-3-12 text-right"><a href="hotels/<?php echo $city."/".$hotel_id.".php";?>" class="button-hollow btn-explore small" role="button">Explore</a></div>
							</div>
						</div>
					</div>
				</div>
