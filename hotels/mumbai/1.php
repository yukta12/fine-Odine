...
if($row = mysqli_fetch_assoc($result_set)) {
    ...
    <div class="container margin-t-30">
        ...
        <div id="about" class="padding-20 bg-white margin-t-30 static-p"><h2 class="h5 capitalize">About <?php echo $row['hotel_name'];?>, <?php echo $row['location'];?></h2><br/>
            ...
            <p>The name &lsquo;Barbeque Nation&rsquo; always gets my mouth watering as images of sizzling hot kebabs on
                grills and endless servings of curries fills my mind. Atmosphere is always noisy here, filled to the
                brim
                with chirpy families and large groups of friends coming in to enjoy the endless pleasures of this
                wonderful
                chain restaurant. Barbeque Nation has to be the fastest growing chain of restaurants in the country. The
                brand is responsible for revolutionizing the concept of family-style dining with its interesting
                gimmicks of
                live grills and pre-fix bills. <strong>Mumbai alone has about thirteen outlets of Barbeque Nation and
                    practically each vicinity has one</strong>. If you are near Navi Mumbai then try the one in Sector 6
                on
                Palm Beach Road in Nerul. From its first-floor perch, it attracts quite a crowd of gourmets.</p>

            <p><strong>We all know Barbeque Nation to be a food mecca where you can indulge in several cuisines at the
                    same
                    time</strong>. On one hand you have the pleasure of feasting on splendid North Indian cuisine and on
                the
                other there is Chinese, Mediterranean and Continental cuisines. <strong>Every table gets a personalized
                    live
                    grill on which you can try your hand by playing chef.</strong> For a pre-fix bill you can eat to
                your
                heart&rsquo;s content. For first course nibble on, mutton seekh kebab, paneer tikka, peshawari chicken,
                tandoori mushroom, barbeque fish, Cajun spicy baby potato, afghani mutton seekh kebab and crispy corn
                chilli
                pepper. In main course mop up the curries like, Indian crab curry, biryani, mutton curry, oriental fish
                gravy, chicken biryani, crab masala, veg noodles, prawn curry, dal makhana and paneer butter masala.</p>

            <p>To end the meal on a strong note pick a few flavours from their live kulfi counter. If not, stick to the
                conventional classic desserts like, brownie, pudding, ice cream, gulab jamun and pastries. With a lychee
                flavoured mocktail give your meal a refreshing finish. Service is smooth and cordial. Staff takes care
                to
                keep refilling your grill with appetizers or anything else you might need. Like every other Barbeque
                Nation
                outlet, this one too is decorated in earthy wooden shades. Every table is shielded by a low faux brick
                wall
                to accord the diners some privacy. <strong>Sit in their breezy terrace section if possible for a
                    relaxing
                    meal with family</strong>. The vibe is informal and cozy here. Go someplace else for a quiet
                atmosphere,
                Barbeque Nation gets noisy.</p></div>
