...
<head>
    ...
    <link media="all" type="text/css" rel="stylesheet"
          href="../../build/web/groot/css/base208d.css?id=ff0dc9fde3cfa214af11">
    <link media="all" type="text/css" rel="stylesheet"
          href="../../build/web/groot/css/homee7fa.css?id=7ccd153e9afc40322ce3">
...
if ($row = mysqli_fetch_assoc($result_set)) {
    ...
    <div class="container margin-t-30">
        ...
        <div id="about" class="padding-20 bg-white margin-t-30 static-p"><h2 class="h5 capitalize">
                About <?php echo $row['hotel_name']; ?>, <?php echo $row['location']; ?></h2><br/>

            <p>Bhoomi is a fantastic joint where you can treat your taste buds to some of the most exotic and fine
                flavours of tea . The lounge with the backdrop of the picturesque surroundings of lush green Vedic
                Village Spa Resort is Placed in Shikharpur, Rajarhat New Town, Kolkata and is surrounded by magnificent
                fountain area. Vedic Village Spa Resort at Shikharpur, is easily approachable with nearly 15 minutes
                drive from Rajarhat. </p>

            <p> Bhoomi is a distinctly designed two storied mud house with thatched roof similar to a typical Bengal
                village. It has a courtyard and delicate indigenous and beautiful Bengali artwork. The entrance is very
                impressive and very refreshing with earthenware and magnificent clay handicrafts, strategically set into
                earthen niches which adorn the gateway. The restaurant looking like a village hut, is dimly lit with
                beautiful terra cotta figurines which are artistically placed. The interiors are highlighted with
                typical wooden chairs and tables </p>

            <p>.As you enter the premises you will be welcomed with a 'tilak' a floral garland by a lady in traditional
                benagli attire of a red bordered white sari . You can listen to melodious numbers sung by live bengali
                folk singer. The restaurant structure is superb with small balconies and staircases and this adds a
                rugged aura to the place and helps to create the right mood. You can have drinks and spend a lovely
                evening. It is open from 12:30 PM to 3:30 PM and, 7:30 PM to 10:30 PM .The pricing is perfect since the
                cost is INR 1800 for two people with alcohol.</p>
        </div>
